...
coverImage: /assets/blog/notes/2025/02/gitlab-cicd.jpg
date: 2025-02-21
---
...
2. 取得 Container Registry 路徑：
    - 格式為：`registry.gitlab.com/<username>/<project-name>`
    - 或：`registry.gitlab.com/<group>/<project-name>`
